    ...
    <main class="main-content">
        ...
        <div class="dashboard-scroll">
            ...
            <div class="input-wrapper">
                ...
                <input type="text" placeholder="Type or speak to capture a thought..." aria-label="Capture thought">
                    ...
                    <div class="widget deadlines-widget">
                        ...
                        <div class="deadline-list">
                            <div class="deadline-item">
                                <div class="deadline-title red-text"><i class='bx bx-error-circle'></i> API Integration</div>
...
<style>
    ...
    .accent-icon { color: var(--accent-purple); margin-right: 0.5rem; }
    ...
    .nav-item i { font-size: 1.25rem; margin-right: 0.75rem; }
    .nav-item:hover { background-color: var(--card-hover); color: var(--text-white); }
    .nav-item.active {
    ...
    .logout-btn {
        ...
        padding: 0.5rem; color: var(--text-gray); text-decoration: none; font-size: 0.875rem;
        background: none; border: none; cursor: pointer;
    }
    .logout-btn:hover { color: var(--accent-red); }
    .logout-btn i { margin-right: 0.75rem; }
    ...
    .header-left h2 { color: var(--text-white); font-size: 1.25rem; margin: 0; font-weight: 600; }
    .status-indicator { font-size: 0.75rem; color: var(--accent-green); display: flex; align-items: center; margin-top: 0.25rem; }
    .pulse-dot { width: 0.5rem; height: 0.5rem; background-color: var(--accent-green); border-radius: 50%; margin-right: 0.5rem; animation: pulse 2s infinite; }
    ...
    .search-bar input {
        ...
        padding: 0.5rem 1rem 0.5rem 2.5rem; border-radius: 0.5rem; color: var(--text-white); outline: none; width: 16rem;
    }
    .search-bar i { position: absolute; left: 0.75rem; top: 0.6rem; color: var(--text-gray); }
    .avatar { width: 2rem; height: 2rem; border-radius: 50%; background: linear-gradient(to top right, var(--accent-purple), var(--accent-blue)); display: flex; align-items: center; justify-content: center; color: white; font-size: 0.75rem; font-weight: bold; }
    ...
    .icon-bg.green { color: var(--accent-green); }
    ...
    .input-wrapper input {
        ...
        padding: 0.875rem 3rem; border-radius: 0.75rem; color: var(--text-white); outline: none;
        box-sizing: border-box; font-size: 1rem;
        transition: border-color 0.2s, box-shadow 0.2s;
    }
    .input-wrapper input:focus { border-color: var(--accent-purple); box-shadow: 0 0 0 1px var(--accent-purple); }
    ...
    .widget { background-color: var(--card-bg); border: 1px solid var(--border-color); border-radius: 0.75rem; padding: 1.25rem; display: flex; flex-direction: column; }
    .widget-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; border-bottom: 1px solid var(--border-color); padding-bottom: 1rem; }
    .widget-header h3 { margin: 0; font-size: 1rem; color: var(--text-white); }

    /* TASKS */
    .tasks-widget { min-height: 400px; }
    .task-item { display: flex; align-items: center; padding: 0.75rem; border-radius: 0.5rem; cursor: pointer; transition: background 0.2s; margin-bottom: 0.25rem; }
    .task-item:hover { background-color: var(--card-hover); }
    .task-item .task-text { flex: 1; font-size: 0.875rem; color: #d1d5db; margin: 0 0.75rem; }
    .task-item:hover .task-text { color: white; }
    .circle { width: 1.25rem; height: 1.25rem; border: 2px solid #4b5563; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 0.75rem; }
    .circle.checked { background-color: var(--accent-green); border-color: var(--accent-green); color: black; }
    .tag { background-color: #2A2B3D; color: #9ca3af; font-size: 0.625rem; padding: 0.1rem 0.5rem; border-radius: 0.25rem; margin-right: 0.5rem; }
    .task-item.completed .task-text { text-decoration: line-through; color: #6b7280; }
    .task-item.completed { opacity: 0.6; }

    /* SIDE WIDGETS */
    .side-widgets { display: flex; flex-direction: column; gap: 1.5rem; }
    .chart-widget { height: 12rem; }
    .chart-container { flex: 1; position: relative; width: 100%; }
    .deadlines-widget { flex: 1; }
    .deadline-item { display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; font-size: 0.875rem; }
    .deadline-title { display: flex; align-items: center; color: var(--text-gray); }
    .deadline-title.red-text { color: var(--accent-red); }
    .deadline-title i { margin-right: 0.5rem; font-size: 1.1rem; }
    ...
    .mob-item {
        ...
        color: var(--text-gray); font-size: 0.6rem; cursor: pointer;
    }
    .mob-item i { font-size: 1.25rem; margin-bottom: 0.2rem; }
    .mob-item.active { color: var(--accent-purple); }
    ...
    @media (max-width: 768px) {
        ...
        .main-content { padding-bottom: 4rem; } /* Space for nav */
