...
<div class="scroll-area fade-in">
    <div class="header-actions">
        <h2>Focus Timer</h2>
        <button class="log-btn" onclick={() => showLog = true}>
    ...
    {#if showLog}
        ...
        <div class="modal-backdrop" onclick={() => showLog = false}>
    ...
    <div class="timer-container">
        <div class="mode-selector">
            <button
                ...
                onclick={() => switchMode('pomodoro')}>Pomodoro (25/5)</button
            >
            <button class="mode-btn {mode === '5217' ? 'active' : ''}" onclick={() => switchMode('5217')}
                >52/17 Rule</button
            >
            <button
                class="mode-btn {mode === 'custom' ? 'active' : ''}"
                onclick={() => switchMode('custom')}>Custom</button
            >
        </div>
        ...
        <div class="controls">
            <button class="control-btn secondary" onclick={resetTimer} aria-label="Reset Timer">
            ...
            <button class="control-btn secondary" onclick={skipPhase} aria-label="Skip Phase">
